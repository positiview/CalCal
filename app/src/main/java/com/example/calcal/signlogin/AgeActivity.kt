...
class AgeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        numberPicker = findViewById<NumberPicker>(R.id.ageNumberPicker)


        numberPicker.minValue = 1  // 최소 키 값
        numberPicker.maxValue = 120  // 최대 키 값
        ...
        binding.btnNext.setOnClickListener {
            memberDTO.age = numberPicker.value
            ...
            call.enqueue(object : Callback<String> {
                override fun onResponse(call: Call<String>, response: Response<String>) {
                    ...
                    if (response.isSuccessful) {
                        ...
                        // 젠더페이지로 이동
                        val intent = Intent(this@AgeActivity, LengthActivity::class.java)
                        intent.putExtra("memberDTO", memberDTO)
                        startActivity(intent)
