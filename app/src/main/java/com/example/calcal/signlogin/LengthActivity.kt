...
import com.example.calcal.databinding.ActivityLengthBinding
...
class LengthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        numberPicker = findViewById<NumberPicker>(R.id.lengthNumberPicker)


        numberPicker.minValue = 80 // 최소 키 값
        numberPicker.maxValue = 250  // 최대 키 값
        ...
        binding.btnNext.setOnClickListener {
            memberDTO.length = numberPicker.value
            ...
            call.enqueue(object : Callback<String> {
                override fun onResponse(call: Call<String>, response: Response<String>) {
                    ...
                    if (response.isSuccessful) {
                        ...
                        // 젠더페이지로 이동
                        val intent = Intent(this@LengthActivity, WeightActivity::class.java)
                        intent.putExtra("memberDTO", memberDTO)
                        startActivity(intent)
